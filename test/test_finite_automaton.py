import unittest
from finite_automaton import DeterministicFiniteAutomaton, NondeterministicFiniteAutomaton
...
class TestDeterministicFiniteAutomaton(TestFiniteAutomaton):
    ...
    def setUp(self):
        self.fa = DeterministicFiniteAutomaton(states={"s0", "s1", "s2", "s3", "s4", "s5"},
                                               alphabet={"n", "e", "w", "o", "t"},
...
class TestNondeterministicFiniteAutomaton(TestFiniteAutomaton):
    ...
    def setUp(self):
        self.fa = NondeterministicFiniteAutomaton(states={"s0", "s1", "s2", "s3"},
                                                  alphabet={"a", "b"},
